...
core.register_entity("terras_capixabas:mariposa", {
  initial_properties = { physical = false, collide_with_objects = false, collisionbox = { -0.25, -0.25, -0.25, 0.25, 0.25, 0.25 }, visual = "mesh", mesh = "borboleta.glb", textures = { "mariposa.png" }, visual_size = { x = 1, y = 1 }, backface_culling = false, },
