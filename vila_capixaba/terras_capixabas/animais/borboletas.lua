...
local function register_butterfly(name, texture, inv_image, description)
  core.register_entity("terras_capixabas:" .. name, {
    initial_properties = { physical = false, collide_with_objects = false, collisionbox = { -0.25, -0.25, -0.25, 0.25, 0.25, 0.25 }, visual = "mesh", mesh = "borboleta.glb", textures = { texture }, visual_size = { x = 1, y = 1 }, backface_culling = false, },
...
register_butterfly("borboleta_laranja", "borboleta_laranja.png", "borboleta_laranja_inv.png",
  "Borboleta Laranja Spawn Egg")
