...
core.register_entity("terras_capixabas:gaivota", {
  initial_properties = { physical = false, collide_with_objects = false, collisionbox = { -0.25, -1.01, -0.25, 0.25, -0.5, 0.25 }, visual = "mesh", mesh = "gaivota.glb", textures = { "gaivota.png" }, visual_size = { x = 1, y = 1 }, },
  _animation_ranges = { fly = { x = 0, y = 1 }, stand = { x = 1.25, y = 1.5 }, },
  chirp_interval = 7,
  speed = 6,
  flight_ceiling = 15,
  _mode = "sleeping",
