...
core.register_entity("terras_capixabas:beijaflor", {
  initial_properties = { physical = false, collide_with_objects = false, collisionbox = { -0.25, -0.5, -0.25, 0.25, 0.5, 0.25 }, visual = "mesh", mesh = "beijaflor.glb", textures = { "beijaflor.png" }, visual_size = { x = 1, y = 1 }, backface_culling = false, },
  ...
  on_step = function(self, dtime)
    ...
    if is_day and not self._visible then
      self.object:set_properties({ visual_size = { x = 1, y = 1 }, collisionbox = { -0.25, -0.5, -0.25, 0.25, 0.5, 0.25 }, })
      self._visible = true
