...
core.register_entity("terras_capixabas:patinete_boy", {
initial_properties = {
physical = true,
...
if not self._sound_handle then
 self._sound_handle = core.sound_play("rolima", {
  object = self.object,
  gain = 1,
...
core.register_craftitem("terras_capixabas:pe_patinete_boy", {
...
pos.y = pos.y + 0.5
core.add_entity(pos, "terras_capixabas:patinete_boy")
