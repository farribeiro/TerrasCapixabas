...
local textures={"boia_pneu.png","boia_pneu_amarelo.png","boia_pneu_verde.png"}
...
function boia.on_activate(self,staticdata)
...
function boia.get_staticdata(self)
return minetest.serialize({v=self.v,tex=self.tex})
end

function boia.on_rightclick(self,clicker)
...
function boia.on_detach_child(self,child)
if child then
...
function boia.on_punch(self,puncher)
...
local item="terras_capixabas:boia_pneu"
...
function boia.on_step(self,dtime)
...
minetest.register_entity("terras_capixabas:boia_pneu",boia)

minetest.register_craftitem("terras_capixabas:boia_pneu",{
description="Boia de pneu",
inventory_image="boia_pneu_inv.png",
...
pos.y=pos.y+0.5
local obj=minetest.add_entity(pos,"terras_capixabas:boia_pneu")
