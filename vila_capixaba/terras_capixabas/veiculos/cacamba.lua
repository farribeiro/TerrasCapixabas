-- terras_capixabas/veiculos/cacamba.lua
...
-- Caçamba Entity
core.register_entity("terras_capixabas:vh_cacamba", {
    initial_properties = {
        visual = "mesh",
        mesh = "cacamba.glb",
    ...
    on_rightclick = function(self, clicker)
        ...
        if not self._driver then
            ...
            clicker:set_eye_offset({x=0, y=26, z=3}, {x=0, y=22, z=-22})
...
core.register_craftitem("terras_capixabas:vh_cacamba_spawn_egg", {
    description = "Caçamba",
    inventory_image = "cacamba_inv.png",
    on_place = function(itemstack, placer, pointed_thing)
        if pointed_thing.type ~= "node" then return itemstack end
        local pos = pointed_thing.above
        pos.y = pos.y + 0.1
        local obj = core.add_entity(pos, "terras_capixabas:vh_cacamba")
