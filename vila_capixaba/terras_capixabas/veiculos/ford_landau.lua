-- terras_capixabas/veiculos/ford_landau.lua
...
core.register_entity("terras_capixabas:vh_landau", {
initial_properties = {
visual = "mesh",
mesh = "landau.glb",
textures = {"landau.png"},
...
-- SAME GRAVITY LOGIC AS DODGE VAN
...
core.register_craftitem("terras_capixabas:vh_landau_spawn_egg",{
description="Landau",
inventory_image="landau_inv.png",
on_place=function(itemstack,placer,pointed_thing)
if pointed_thing.type~="node" then return itemstack end
local pos=pointed_thing.above
pos.y=pos.y+0.5
local obj=core.add_entity(pos,"terras_capixabas:vh_landau")
