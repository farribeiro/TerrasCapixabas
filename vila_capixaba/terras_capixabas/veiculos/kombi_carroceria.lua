-- terras_capixabas/veiculos/kombi_carroceria.lua
...
core.register_entity("terras_capixabas:vh_kombi_carroceria", {
    initial_properties = {
        visual = "mesh",
        mesh = "kombi_carroceria.glb",
        textures = {"kombi_carroceria.png"},
        visual_size = {x=1, y=1},
        physical = true,
...
core.register_craftitem("terras_capixabas:vh_kombi_carroceria_spawn_egg", {
    description = "kombi_carroceria",
    inventory_image = "kombi_carroceria_inv.png",
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        local obj = core.add_entity(pos, "terras_capixabas:vh_kombi_carroceria")
