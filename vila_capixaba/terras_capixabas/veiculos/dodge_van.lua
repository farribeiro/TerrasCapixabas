-- terras_capixabas/veiculos/dodge_van.lua
...
core.register_entity("terras_capixabas:vh_dodge_van", {
    initial_properties = {
        visual = "mesh",
        mesh = "dodge_van.glb",
        textures = {"dodge_van.png"},
        visual_size = {x=1, y=1},
        physical = true,
    ...
    on_rightclick = function(self, clicker)
        ...
        if not self._driver then
            ...
            clicker:set_eye_offset({x=0, y=12, z=0}, {x=0, y=10, z=0})
...
core.register_craftitem("terras_capixabas:vh_dodge_van_spawn_egg", {
    description = "dodge_van",
    inventory_image = "dodge_van_inv.png",
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        local obj = core.add_entity(pos, "terras_capixabas:vh_dodge_van")
