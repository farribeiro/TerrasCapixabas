-- terras_capixabas/veiculos/caminhaozinho.lua
...
-- Caminhãozinho Entity
core.register_entity("terras_capixabas:vh_caminhaozinho", {
    initial_properties = {
        visual = "mesh",
        mesh = "caminhaozinho.glb",
        textures = {"caminhaozinho.png"},
        visual_size = {x=1, y=1},
        physical = true,
    ...
    on_rightclick = function(self, clicker)
        ...
        if not self._driver then
            ...
            clicker:set_attach(self.object, "", {x = 0, y = 20, z = 0}, {x = 0, y = 0, z = 0})
            clicker:set_eye_offset({x=0, y=20, z=0}, {x=0, y=22, z=-22})
...
core.register_craftitem("terras_capixabas:vh_caminhaozinho_spawn_egg", {
    description = "Caminhãozinho",
    inventory_image = "caminhaozinho_inv.png",
    on_place = function(itemstack, placer, pointed_thing)
        if pointed_thing.type ~= "node" then return itemstack end
        local pos = pointed_thing.above
        pos.y = pos.y + 0.1
        local obj = core.add_entity(pos, "terras_capixabas:vh_caminhaozinho")
